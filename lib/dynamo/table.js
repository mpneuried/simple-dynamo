...
(function() {
  ...
  module.exports = DynamoTable = (function(_super) {
    ...
    DynamoTable.prototype.find = function() {
      var args, cb, options, query, startAt, _i, _op, _query, _ref, _val, _x,
        _this = this;
      args = 2 <= arguments.length ? __slice.call(arguments, 0, _i = arguments.length - 1) : (_i = 0, []), cb = arguments[_i++];
      if (this._isExistend(cb)) {
        options = null;
        ...
        if (this._isExistend(cb)) {
          _query = this._attrs.getQuery(this.external, query, startAt, options);
    ...
    DynamoTable.prototype._getOptions = function(options) {
      ...
      _defOpt = {
        removeMissing: this._model_settings.removeMissing != null ? this._model_settings.removeMissing : false,
        fields: null,
    ...
    DynamoTable.prototype._create = function(attributes, options, cb) {
      ...
      this._createId(attributes, function(err, attributes) {
        ...
        if (err) {
          ...
          _upd = _this._checkSetOptions(_upd, attributes, options);
    ...
    DynamoTable.prototype._checkSetOptions = function(_upd, attributes, options) {
      var _pred;
      if (!(options != null ? options.overwriteExistingHash : void 0) || !this.overwriteExistingHash) {
        _pred = {};
        _pred[this.hashKey] = {
          "==": null
        };
