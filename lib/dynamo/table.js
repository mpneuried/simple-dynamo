  ...
  module.exports = DynamoTable = (function() {
    ...
    DynamoTable.prototype.get = function() {
      ...
      if (this._isExistend(cb)) {
        ...
        this._get(query, options, __bind(function(err, _item) {
          var _obj;
          if (err) {
            this._error(cb, err);
          } else {
    ...
    DynamoTable.prototype.set = function() {
      ...
      if (this._isExistend(cb)) {
        ...
        options = this._getOptions(options);
        this._attrs.validateAttributes(_create, attributes, __bind(function(err, attributes) {
          if (err) {
            ...
            if (_create) {
              ...
              return this._update(_id, attributes, options, __bind(function(err, _curr, _old, _deletedKeys) {
                var _k, _new, _obj, _oldRem, _ref, _ref2, _v;
                if (err) {
                  this._error(cb, err);
                } else {
                  if (_old) {
                    ...
                    if (options != null ? (_ref = options.fields) != null ? _ref.length : void 0 : void 0) {
                      _new = utils.reduceObj(_new, options != null ? options.fields : void 0);
                    }
                    cb(null, _new);
                  } else {
                    _curr[this.hashKey] = _curr[this.hashKey].replace(this._regexRemCT, "");
                    this.emit("update", _curr, _curr);
                    if (options != null ? (_ref2 = options.fields) != null ? _ref2.length : void 0 : void 0) {
                      _curr = utils.reduceObj(_curr, options != null ? options.fields : void 0);
                    }
                    cb(null, _curr);
                  }
                }
    ...
    DynamoTable.prototype.find = function() {
      var args, cb, cursor, options, query, _i, _op, _query, _ref, _val, _x;
      args = 2 <= arguments.length ? __slice.call(arguments, 0, _i = arguments.length - 1) : (_i = 0, []), cb = arguments[_i++];
      if (this._isExistend(cb)) {
        options = null;
        cursor = null;
        switch (args.length) {
          ...
          case 2:
            ...
            break;
          case 3:
            query = args[0], cursor = args[1], options = args[2];
        }
        options = this._getOptions(options);
        if (cursor != null) {
        ...
        if (this._isExistend(cb)) {
          ...
          if (options != null ? (_ref = options.fields) != null ? _ref.length : void 0 : void 0) {
            _query.get(options != null ? options.fields : void 0);
          }
    ...
    DynamoTable.prototype._getOptions = function(options) {
      ...
      _defOpt = {
        removeMissing: this._model_settings.removeMissing != null ? this._model_settings.removeMissing : true,
        fields: null
      };
    ...
    DynamoTable.prototype._get = function(query, options, cb) {
      var _item, _ref, _ref2;
      _item = this.external.get(query);
      if (options != null ? (_ref = options.fields) != null ? _ref.length : void 0 : void 0) {
        _item.get(options.fields);
      }
      console.log(options, options != null ? (_ref2 = options.fields) != null ? _ref2.length : void 0 : void 0);
    ...
    DynamoTable.prototype._update = function(id, attributes, options, cb) {
      ...
      this.get(id, __bind(function(err, current) {
        ...
        if (err) {
          ...
          _upd = item.update(this._attrs.updateAttrsFn(current, attributes, options));
